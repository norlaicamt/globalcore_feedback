...
const styles = {
  ...
  title: { margin: '0 0 12px 0', fontSize: '18px', fontWeight: '800', color: 'var(--primary-color)' },
  ...
  primaryBtn: { padding: '10px 16px', borderRadius: '10px', backgroundColor: 'var(--primary-color)', color: 'white', border: 'none', fontWeight: 'bold', cursor: 'pointer', flex: 1 }
};
