                  ...
                  <div style={styles.cardHeader}>
                    ...
                    {onViewPost && (
                      <button 
                        ...
                        onClick={(e) => { e.stopPropagation(); onViewPost(act.feedback_id); }}
                      >
                        View
                      </button>
                    )}
...
const styles = {
  ...
  card: { backgroundColor: 'white', borderRadius: '12px', padding: '16px', border: '1px solid #E2E8F0', boxShadow: '0 1px 2px rgba(0,0,0,0.02)' },
